...
if(isset($_SESSION['zalogowany_rejestrator'])){
    if(isset($_SESSION['sukces_uzupelnienia_danych'])){?>
        ...
        <p class='strona-glowna'><a href='rej-strona-glowna.php'>Przejdź do strony głównej</a></p>
        ...
        <?php
            if(isset($_SESSION['blad_zmien_haslo_sukces_uzupelnienia_danych'])){
                ...
                </style><p><b>Nie udało się zaktualizować Twojego hasła. Zwróć uwagę na poprawność danych i spróbuj ponownie.</b></p><?php
        ...
        <div class='nowe-haslo-formularz'>
            <form action='rej-wpisz-nowe-haslo.php' method='post'>
