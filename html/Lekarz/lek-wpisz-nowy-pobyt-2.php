...
?>
<?php
if(isset($_POST['lek_dodaj_pobyt_pacjenta_z_historia'])){
    if($_POST['oddzial'] == 'nie_wybrano' || $_POST['schorzenie'] == 'nie_wybrano'){
        ...
        if(!$dodaj_pobyt){
            ...
            $uzupelnij_pacjenta = $link->prepare("UPDATE pacjent SET id_pobytu=?, id_lekarza=?, data_rozpoczecia_ostatniego_pobytu=?, data_zakonczenia_ostatniego_pobytu=NULL WHERE id_pacjenta=?");
